...
type CalculatorServiceClient interface {
	...
	PrimeManyTimes(ctx context.Context, in *PrimeRequest, opts ...grpc.CallOption) (CalculatorService_PrimeManyTimesClient, error)
...
func (c *calculatorServiceClient) PrimeManyTimes(ctx context.Context, in *PrimeRequest, opts ...grpc.CallOption) (CalculatorService_PrimeManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/calculator.CalculatorService/PrimeManyTimes", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorServicePrimeManyTimesClient) Recv() (*PrimeResponse, error) {
	m := new(PrimeResponse)
...
type CalculatorServiceServer interface {
	...
	PrimeManyTimes(*PrimeRequest, CalculatorService_PrimeManyTimesServer) error
...
func (UnimplementedCalculatorServiceServer) PrimeManyTimes(*PrimeRequest, CalculatorService_PrimeManyTimesServer) error {
...
func (x *calculatorServicePrimeManyTimesServer) Send(m *PrimeResponse) error {
